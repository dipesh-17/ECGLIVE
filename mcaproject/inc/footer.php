<!-- ======= Footer ======= -->
  <footer id="footer" class="footer custom-footer">
    ...
    <div class="container">
      <!-- <div class="row">  
        ...
        <a href="https://instagram.com/ecglive" target="blank">
          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
            ...
            <p>
              <br>
            <br><br>
              <strong>Phone:</strong> +91 976 770 0770<br>
              <strong>Email:</strong> support@ecglive.com<br>
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 footer-links">
          <h4>Useful Links</h4>
          <ul>
            <li><i class="bi bi-chevron-right"></i> <a href="https://ecglive.com">Home</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="https://ecglive.com/privacy-policy.html">Privacy Policy</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="https://ecglive.com/disclaimer.html">Disclaimer</a></li>
        ...
        <div class="col-lg-4 col-md-6 footer-links">
          ...
          <ul>
           <li><i class="bi bi-chevron-right"></i> <a href="#"></a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="#">ECG Interpretation</a></li>
  ...
  <hr>
    ...
    <div class="footer-copyright">
        <p>© Medical Reports - Online consultation</p>
      </div>    
    </div>
  </footer>
