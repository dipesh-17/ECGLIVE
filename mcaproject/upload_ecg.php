...
<div class="form-container col-9 col-lg-9">
        <form action="" id="addecg" method="post" enctype="multipart/form-data">
            <fieldset id="form1">
                <div class="fieldset-content">
                    <div class="form-row" id="pdfups">
                            <p><strong> Upload PDF/Smartwatch ECG file</strong></p>
                    ...
                    <div class="form-row" id="imagesups">                          
                        <p><strong>Upload Images of ECG</strong></p>
                        <div class="input-group mb-3 col-sm-12 col-lg-8">                             
            ...
            <fieldset id="form2">
            <div class="fieldset-content">
                <h6 class="text-center">Add some extra information about this ECG</h6><hr>
                    <div class="form-group">
                        <label for="ecgdate" class="cblabel">ECG recording date</label>
        ...
        <div class="step-row">
            <div id="progress"></div>
            <div class="step-col hzl"><small>Upload ECG Files</small></div>
            <div class="step-col"><small>ECG Information</small></div> 
        </div>
    </div>
</div>
