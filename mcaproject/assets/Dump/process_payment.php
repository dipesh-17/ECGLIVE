...
if(isset($_POST['payment_id']) && isset($_SESSION['OID']) && isset($_POST['plan_id'])){
    ...
    if ($plan_id==19) {
        mysqli_query($conn,"insert into pl_basic9(userid,transaction_id,rp_allow,pl_status,pl_s_date) values('$userid','$tr_id', 1, 1,'$pl_s_date')");

    }    
    if ($plan_id==199) {
        mysqli_query($conn,"insert into pl_premium99(userid,transaction_id,rp_allow,rem_rp,pl_s_date,pl_e_date,pl_status) values('$userid','$tr_id', 12, 12, '$pl_s_date', '$pl_e_date',1)");
